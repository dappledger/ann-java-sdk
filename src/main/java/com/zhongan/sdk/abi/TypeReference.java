package com.zhongan.sdk.abi;

import com.zhongan.sdk.abi.datatypes.Array;
 ...
 */
public abstract class TypeReference<T extends com.zhongan.sdk.abi.datatypes.Type>
    ...
    public static <T extends com.zhongan.sdk.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.zhongan.sdk.abi.datatypes.Type>
