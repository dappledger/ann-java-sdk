...
public class RawResponseDeserializer
        extends StdDeserializer<BaseResp> implements ResolvableDeserializer {

    private final JsonDeserializer<?> defaultDeserializer;

    public RawResponseDeserializer(JsonDeserializer<?> defaultDeserializer) {
        super(BaseResp.class);
        this.defaultDeserializer = defaultDeserializer;
    }

    @Override
    public BaseResp deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        BaseResp deserializedResponse = (BaseResp) defaultDeserializer.deserialize(jp, ctxt);
