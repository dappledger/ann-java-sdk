...
import static annchain.genesis.sdk.utils.utils.Assertions.verifyPrecondition;
...
public class Sign {
    ...
    public static String signAMessage(byte[] message, ECKeyPair keyPair, boolean isHashed) {
        byte[] messageHash;
        if (isHashed) {
            messageHash = Hash.sha3(message);
        } else {
       ...
       return keyPair.anChainSign(messageHash);
    }
    ...
    public static class SignatureData {
        ...
        public byte[] getData() {
            return ArrayUtils.addAll(ArrayUtils.addAll(r,s),v);
        }
