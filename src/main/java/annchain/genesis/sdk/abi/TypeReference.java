...
import annchain.genesis.sdk.abi.datatypes.Array;
 ...
 */
public abstract class TypeReference<T extends annchain.genesis.sdk.abi.datatypes.Type>
    ...
    public static <T extends annchain.genesis.sdk.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends annchain.genesis.sdk.abi.datatypes.Type>
